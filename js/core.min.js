...
!function(a){"use strict";var s={playlistClass:"playlist",fixed:!0,fixedClass:"fixed-player",fixedBG:"#000",nav:!0,navClass:["fa fa-angle-double-left","fa fa-angle-double-right"],showTitle:!0};a.fn.rdAudio=function(l){function i(a){e.html(a)}l=a.extend(!0,{},s,l);var t=a("."+l.fixedClass),d=audiojs.createAll({trackEnded:function(){var s;for(p in d)a("."+l.playlistClass+" li.playing").parent().data("player-id")==a(d[p].wrapper).find("audio").attr("id")&&(s=p);var i=a("."+l.playlistClass+'[data-player-id="'+a(d[s].wrapper).find("audio").attr("id")+'"] li.playing'),t=i.next();t.length||(t=i.parent().find("li").first()),t.addClass("playing").siblings().removeClass("playing"),d[s].load(t.attr("data-src")),d[s].play()}});if(l.showTitle){a(".audiojs .time").after('<div class="rdaudio-title"></div>');var e=a(".rdaudio-title")}if(l.nav&&(a(".audiojs .play-pause").after('<div class="rdaudio-nav"><i class="rdaudio-prev '+l.navClass[0]+'"></i><i class="rdaudio-next '+l.navClass[1]+'"></i></div>'),a(".rdaudio-prev").click(function(){var s,t,e;a("."+l.playlistClass+" .playing").length>0?(s=a("."+l.playlistClass).find(".playing"),e=1):a("."+l.playlistClass+" .stopped").length>0&&(s=a("."+l.playlistClass).find(".stopped"),e=0),t=s.prev().length?s.prev():s,1==e?(s.removeClass("playing"),t.addClass("playing")):(s.removeClass("stopped"),t.addClass("stopped")),i(t.find(".title").text());for(var p=0;p<d.length;p++)d[p].pause(),d[p].load(t.attr("data-src")),1==e&&d[p].play()}),a(".rdaudio-next").click(function(){var s,t,e;a("."+l.playlistClass+" .playing").length>0?(s=a("."+l.playlistClass).find(".playing"),e=1):a("."+l.playlistClass+" .stopped").length>0&&(s=a("."+l.playlistClass).find(".stopped"),e=0),t=s.next().length?s.next():s,1==e?(s.removeClass("playing"),t.addClass("playing")):(s.removeClass("stopped"),t.addClass("stopped")),i(t.find(".title").text());for(var p=0;p<d.length;p++)d[p].pause(),d[p].load(t.attr("data-src")),1==e&&d[p].play()})),a("."+l.playlistClass).length>0)for(var p=0;p<d.length;p++){var r=a("."+l.playlistClass+"[data-player-id='"+a(d[p].wrapper).find("audio").attr("id")+"'] li").first();r.addClass("stopped"),i(r.find(".title").text()),d[p].load(r.data("src"))}a(".play-pause").click(function(s){var i,t=a(this).parent().find("audio").attr("id");for(var s in d)t==a(d[s].wrapper).find("audio").attr("id")&&(i=s);a(this).parent().hasClass("playing")?a("."+l.playlistClass+'[data-player-id="'+t+'"] li.stopped').addClass("playing").removeClass("stopped"):a("."+l.playlistClass+'[data-player-id="'+t+'"] li.playing').addClass("stopped").removeClass("playing");for(s in d)t!=a(d[s].wrapper).find("audio").attr("id")&&(a("."+l.playlistClass+'[data-player-id="'+a(d[s].wrapper).find("audio").attr("id")+'"] li.playing').removeClass("playing").addClass("stopped"),d[s].pause())}),a("."+l.playlistClass+" li").click(function(s){var e=a(this).parent().data("player-id"),p=!1;for(var r in d)if(e==a(d[r].wrapper).find("audio").attr("id")){if(a(this).hasClass("playing"))return d[r].playPause(),void a(this).removeClass("playing").addClass("stopped");if(a(this).hasClass("stopped"))return d[r].playPause(),a(this).removeClass("stopped").addClass("playing"),void(l.fixed&&t.is(":hidden")&&t.fadeIn(500))}a("."+l.playlistClass+'[data-player-id="'+e+'"] li.stopped').removeClass("stopped");for(var r in d)e!=a(d[r].wrapper).find("audio").attr("id")&&a("."+l.playlistClass+'[data-player-id="'+a(d[r].wrapper).find("audio").attr("id")+'"] li.playing').removeClass("playing").addClass("stopped");for(r in d)e==a(d[r].wrapper).find("audio").attr("id")&&(p=!0);if(p)for(r in d)e==a(d[r].wrapper).find("audio").attr("id")?(a("."+l.playlistClass+" li").removeClass("playing"),a(this).addClass("playing").siblings().removeClass("playing"),i(a(this).find(".title").text()),d[r].load(a(this).attr("data-src")),d[r].play()):d[r].pause();l.fixed&&t.fadeIn(500)}),l.fixed&&(t.css({display:"none",position:"fixed",bottom:"0",left:"0",right:"0",background:l.fixedBG}),t.append('<span class="close-button fa fa-times"></span>'),a(".close-button").click(function(s){s.preventDefault();for(var i in d)d[i].pause(),a("."+l.playlistClass+" li.playing").removeClass("playing"),a("."+l.playlistClass+" li.stopped").removeClass("stopped");t.fadeOut(300)}))}}(jQuery);

!function(e,t,a){var s=function(){for(var e=/audio(.min)?.js.*/,t=document.getElementsByTagName("script"),a=0,s=t.length;s>a;a++){var n=t[a].getAttribute("src");if(e.test(n))return n.replace(e,"")}}();console.log(s),a[e]={instanceCount:0,instances:{},flashSource:'      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="$1" width="1" height="1" name="$1" style="position: absolute; left: -1px;">         <param name="movie" value="$2?playerInstance='+e+'.instances[\'$1\']&datetime=$3">         <param name="allowscriptaccess" value="always">         <embed name="$1" src="$2?playerInstance='+e+'.instances[\'$1\']&datetime=$3" width="1" height="1" allowscriptaccess="always">       </object>',settings:{autoplay:!1,loop:!1,preload:!0,imageLocation:"images/player-graphics.gif",swfLocation:"images/audiojs.swf",useFlash:function(){var e=document.createElement("audio");return!(e.canPlayType&&e.canPlayType("audio/mpeg;").replace(/no/,""))}(),hasFlash:function(){if(navigator.plugins&&navigator.plugins.length&&navigator.plugins["Shockwave Flash"])return!0;if(navigator.mimeTypes&&navigator.mimeTypes.length){var e=navigator.mimeTypes["application/x-shockwave-flash"];return e&&e.enabledPlugin}try{return new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),!0}catch(t){}return!1}(),createPlayer:{markup:'          <div class="play-pause">             <p class="play"></p>             <p class="pause"></p>             <p class="loading"></p>             <p class="error"></p>           </div>           <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>           <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',playPauseClass:"play-pause",scrubberClass:"scrubber",progressClass:"progress",loaderClass:"loaded",timeClass:"time",durationClass:"duration",playedClass:"played",errorMessageClass:"error-message",playingClass:"playing",loadingClass:"loading",errorClass:"error"},trackEnded:function(){},flashError:function(){var t=this.settings.createPlayer,s=n(t.errorMessageClass,this.wrapper),r='Missing <a href="http://get.adobe.com/flashplayer/">flash player</a> plugin.';this.mp3&&(r+=' <a href="'+this.mp3+'">Download audio file</a>.'),a[e].helpers.removeClass(this.wrapper,t.loadingClass),a[e].helpers.addClass(this.wrapper,t.errorClass),s.innerHTML=r},loadError:function(){var t=this.settings.createPlayer,s=n(t.errorMessageClass,this.wrapper);a[e].helpers.removeClass(this.wrapper,t.loadingClass),a[e].helpers.addClass(this.wrapper,t.errorClass),s.innerHTML='Error loading: "'+this.mp3+'"'},init:function(){a[e].helpers.addClass(this.wrapper,this.settings.createPlayer.loadingClass)},loadStarted:function(){var t=this.settings.createPlayer,s=n(t.durationClass,this.wrapper),r=Math.floor(this.duration/60),i=Math.floor(this.duration%60);a[e].helpers.removeClass(this.wrapper,t.loadingClass),s.innerHTML=(10>r?"0":"")+r+":"+(10>i?"0":"")+i},loadProgress:function(e){var t=this.settings.createPlayer,a=n(t.scrubberClass,this.wrapper);n(t.loaderClass,this.wrapper).style.width=a.offsetWidth*e+"px"},playPause:function(){this.playing?this.settings.play():this.settings.pause()},play:function(){a[e].helpers.addClass(this.wrapper,this.settings.createPlayer.playingClass)},pause:function(){a[e].helpers.removeClass(this.wrapper,this.settings.createPlayer.playingClass)},updatePlayhead:function(e){var t=this.settings.createPlayer,a=n(t.scrubberClass,this.wrapper);n(t.progressClass,this.wrapper).style.width=a.offsetWidth*e+"px",t=n(t.playedClass,this.wrapper),a=this.duration*e,e=Math.floor(a/60),a=Math.floor(a%60),t.innerHTML=(10>e?"0":"")+e+":"+(10>a?"0":"")+a}},create:function(e,t){return t=t||{},e.length?this.createAll(t,e):this.newInstance(e,t)},createAll:function(e,t){var a=t||document.getElementsByTagName("audio"),s=[];e=e||{};for(var n=0,r=a.length;r>n;n++)s.push(this.newInstance(a[n],e));return s},newInstance:function(e,s){var n=this.helpers.clone(this.settings),r="audiojs"+this.instanceCount,i="audiojs_wrapper"+this.instanceCount;return this.instanceCount++,null!=e.getAttribute("autoplay")&&(n.autoplay=!0),null!=e.getAttribute("loop")&&(n.loop=!0),"none"==e.getAttribute("preload")&&(n.preload=!1),s&&this.helpers.merge(n,s),n.createPlayer.markup?e=this.createPlayer(e,n.createPlayer,i):e.parentNode.setAttribute("id",i),i=new a[t](e,n),n.css&&this.helpers.injectCss(i,n.css),n.useFlash&&n.hasFlash?(this.injectFlash(i,r),this.attachFlashEvents(i.wrapper,i)):n.useFlash&&!n.hasFlash&&this.settings.flashError.apply(i),(!n.useFlash||n.useFlash&&n.hasFlash)&&this.attachEvents(i.wrapper,i),this.instances[r]=i},createPlayer:function(e,t,a){var s=document.createElement("div"),n=e.cloneNode(!0);return s.setAttribute("class","audiojs"),s.setAttribute("className","audiojs"),s.setAttribute("id",a),n.outerHTML&&!document.createElement("audio").canPlayType?(n=this.helpers.cloneHtml5Node(e),s.innerHTML=t.markup,s.appendChild(n),e.outerHTML=s.outerHTML,s=document.getElementById(a)):(s.appendChild(n),s.innerHTML+=t.markup,e.parentNode.replaceChild(s,e)),s.getElementsByTagName("audio")[0]},attachEvents:function(t,s){if(s.settings.createPlayer){var r=s.settings.createPlayer,i=n(r.playPauseClass,t),l=n(r.scrubberClass,t);a[e].events.addListener(i,"click",function(){s.playPause.apply(s)}),a[e].events.addListener(l,"click",function(e){e=e.clientX;var t=this,a=0;if(t.offsetParent)do a+=t.offsetLeft;while(t=t.offsetParent);s.skipTo((e-a)/l.offsetWidth)}),s.settings.useFlash||(a[e].events.trackLoadProgress(s),a[e].events.addListener(s.element,"timeupdate",function(){s.updatePlayhead.apply(s)}),a[e].events.addListener(s.element,"ended",function(){s.trackEnded.apply(s)}),a[e].events.addListener(s.source,"error",function(){clearInterval(s.readyTimer),clearInterval(s.loadTimer),s.settings.loadError.apply(s)}))}},attachFlashEvents:function(e,t){t.swfReady=!1,t.load=function(e){t.mp3=e,t.swfReady&&t.element.load(e)},t.loadProgress=function(e,a){t.loadedPercent=e,t.duration=a,t.settings.loadStarted.apply(t),t.settings.loadProgress.apply(t,[e])},t.skipTo=function(e){e>t.loadedPercent||(t.updatePlayhead.call(t,[e]),t.element.skipTo(e))},t.updatePlayhead=function(e){t.settings.updatePlayhead.apply(t,[e])},t.play=function(){t.settings.preload||(t.settings.preload=!0,t.element.init(t.mp3)),t.playing=!0,t.element.pplay(),t.settings.play.apply(t)},t.pause=function(){t.playing=!1,t.element.ppause(),t.settings.pause.apply(t)},t.setVolume=function(e){t.element.setVolume(e)},t.loadStarted=function(){t.swfReady=!0,t.settings.preload&&t.element.init(t.mp3),t.settings.autoplay&&t.play.apply(t)}},injectFlash:function(e,t){var a=this.flashSource.replace(/\$1/g,t);a=a.replace(/\$2/g,e.settings.swfLocation),a=a.replace(/\$3/g,+new Date+Math.random());var s=e.wrapper.innerHTML,n=document.createElement("div");n.innerHTML=a+s,e.wrapper.innerHTML=n.innerHTML,e.element=this.helpers.getSwf(t)},helpers:{merge:function(e,t){for(attr in t)(e.hasOwnProperty(attr)||t.hasOwnProperty(attr))&&(e[attr]=t[attr])},clone:function(e){if(null==e||"object"!=typeof e)return e;var t,a=new e.constructor;for(t in e)a[t]=arguments.callee(e[t]);return a},addClass:function(e,t){RegExp("(\\s|^)"+t+"(\\s|$)").test(e.className)||(e.className+=" "+t)},removeClass:function(e,t){e.className=e.className.replace(RegExp("(\\s|^)"+t+"(\\s|$)")," ")},injectCss:function(e,t){for(var a="",s=document.getElementsByTagName("style"),n=t.replace(/\$1/g,e.settings.imageLocation),r=0,i=s.length;i>r;r++){var l=s[r].getAttribute("title");if(l&&~l.indexOf("audiojs")){if(i=s[r],i.innerHTML===n)return;a=i.innerHTML;break}}s=document.getElementsByTagName("head")[0],r=s.firstChild,i=document.createElement("style"),s&&(i.setAttribute("type","text/css"),i.setAttribute("title","audiojs"),i.styleSheet?i.styleSheet.cssText=a+n:i.appendChild(document.createTextNode(a+n)),r?s.insertBefore(i,r):s.appendChild(styleElement))},cloneHtml5Node:function(e){var t=document.createDocumentFragment(),a=t.createElement?t:document;return a.createElement("audio"),a=a.createElement("div"),t.appendChild(a),a.innerHTML=e.outerHTML,a.firstChild},getSwf:function(e){return e=document[e]||window[e],e.length>1?e[e.length-1]:e}},events:{memoryLeaking:!1,listeners:[],addListener:function(t,s,n){t.addEventListener?t.addEventListener(s,n,!1):t.attachEvent&&(this.listeners.push(t),this.memoryLeaking||(window.attachEvent("onunload",function(){if(this.listeners)for(var t=0,s=this.listeners.length;s>t;t++)a[e].events.purge(this.listeners[t])}),this.memoryLeaking=!0),t.attachEvent("on"+s,function(){n.call(t,window.event)}))},trackLoadProgress:function(e){if(e.settings.preload){var t,a;e=e;var s=/(ipod|iphone|ipad)/i.test(navigator.userAgent);t=setInterval(function(){e.element.readyState>-1&&(s||e.init.apply(e)),e.element.readyState>1&&(e.settings.autoplay&&e.play.apply(e),clearInterval(t),a=setInterval(function(){e.loadProgress.apply(e),e.loadedPercent>=1&&clearInterval(a)}))},10),e.readyTimer=t,e.loadTimer=a}},purge:function(e){var t,a=e.attributes;if(a)for(t=0;t<a.length;t+=1)"function"==typeof e[a[t].name]&&(e[a[t].name]=null);if(a=e.childNodes)for(t=0;t<a.length;t+=1)purge(e.childNodes[t])},ready:function(){return function(e){var t=window,a=!1,s=!0,n=t.document,r=n.documentElement,i=n.addEventListener?"addEventListener":"attachEvent",l=n.addEventListener?"removeEventListener":"detachEvent",o=n.addEventListener?"":"on",d=function(s){("readystatechange"!=s.type||"complete"==n.readyState)&&(("load"==s.type?t:n)[l](o+s.type,d,!1),!a&&(a=!0)&&e.call(t,s.type||s))},p=function(){try{r.doScroll("left")}catch(e){return void setTimeout(p,50)}d("poll")};if("complete"==n.readyState)e.call(t,"lazy");else{if(n.createEventObject&&r.doScroll){try{s=!t.frameElement}catch(c){}s&&p()}n[i](o+"DOMContentLoaded",d,!1),n[i](o+"readystatechange",d,!1),t[i](o+"load",d,!1)}}}()}},a[t]=function(e,t){this.element=e,this.wrapper=e.parentNode,this.source=e.getElementsByTagName("source")[0]||e,this.mp3=function(e){var t=e.getElementsByTagName("source")[0];return e.getAttribute("src")||(t?t.getAttribute("src"):null)}(e),this.settings=t,this.loadStartedCalled=!1,this.loadedPercent=0,this.duration=1,this.playing=!1},a[t].prototype={updatePlayhead:function(){this.settings.updatePlayhead.apply(this,[this.element.currentTime/this.duration])},skipTo:function(e){e>this.loadedPercent||(this.element.currentTime=this.duration*e,this.updatePlayhead())},load:function(t){this.loadStartedCalled=!1,this.source.setAttribute("src",t),this.element.load(),this.mp3=t,a[e].events.trackLoadProgress(this)},loadError:function(){this.settings.loadError.apply(this)},init:function(){this.settings.init.apply(this)},loadStarted:function(){return this.element.duration?(this.duration=this.element.duration,this.updatePlayhead(),void this.settings.loadStarted.apply(this)):!1},loadProgress:function(){null!=this.element.buffered&&this.element.buffered.length&&(this.loadStartedCalled||(this.loadStartedCalled=this.loadStarted()),this.loadedPercent=this.element.buffered.end(this.element.buffered.length-1)/this.duration,this.settings.loadProgress.apply(this,[this.loadedPercent]))},playPause:function(){this.playing?this.pause():this.play()},play:function(){/(ipod|iphone|ipad)/i.test(navigator.userAgent)&&0==this.element.readyState&&this.init.apply(this),this.settings.preload||(this.settings.preload=!0,this.element.setAttribute("preload","auto"),a[e].events.trackLoadProgress(this)),this.playing=!0,this.element.play(),this.settings.play.apply(this)},pause:function(){this.playing=!1,this.element.pause(),this.settings.pause.apply(this)},setVolume:function(e){this.element.volume=e},trackEnded:function(){this.skipTo.apply(this,[0]),this.settings.loop||this.pause.apply(this),this.settings.trackEnded.apply(this)}};var n=function(e,t){var a=[];if(t=t||document,t.getElementsByClassName)a=t.getElementsByClassName(e);else{var s,n,r=t.getElementsByTagName("*"),i=RegExp("(^|\\s)"+e+"(\\s|$)");for(s=0,n=r.length;n>s;s++)i.test(r[s].className)&&a.push(r[s])}return a.length>1?a:a[0]}}("audiojs","audiojsInstance",this);